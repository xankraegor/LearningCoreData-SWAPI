...
class PlanetsController: UITableViewController, NSFetchedResultsControllerDelegate, UISearchBarDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let descriptionController = segue.destination as? PlanetsDescriptionController {
